...
export function GlxyHeroLogoVideo({
  ...
  return (
    <div ref={rowRef} className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:items-center lg:gap-6 xl:gap-8">
      ...
      {homeHlsSrc ? (
        <div
          className="flex min-w-0 justify-start lg:justify-start lg:pl-1"
